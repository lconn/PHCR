...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data">
...
<!--                                <xsl:call-template name="recordTarget" />-->
                ...
                <!-- SG 20170201: Added for RR **TODO* Change to apply templates -->
